...
def fase1():
    ...
    # Imagem do cliente
    imagem_cliente = pygame.image.load('assets/img/Cliente.png').convert_alpha()
    cliente_width = 120
    cliente_height = 80
    ...
    imagem_entregador = pygame.image.load('assets/img/Entregador.png').convert_alpha()
    ...
    CAR_WIDTH = 80
    CAR_HEIGHT = 140
    car_colors = ['roxo', 'azul', 'rosa', 'verde', 'verdeagua', 'amarelo']
    car_images = {}
